...
public class UpdatePollingTaskParametersServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			sql = "{call update_clock_status_polling_setup("+taskId+", "+paramsNum+", '"+paramsList+"', "+paramsSetting+")}";
