...
(function($) {
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * Section - DataTables variablesiDisplayStart
	 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 *   the fnRecordsTotal() (etc) functions.
			 */ 
			this._iRecordsTotal = 2;
			this._iRecordsDisplay = 2;
		...
		{
			$('#container').load('create_table.jsp');
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			{
				/* Normal record set */
				//Codice modificato da Alfredo Favenza
				nFirst.innerHTML = oSettings.oLanguage.sInfo.
						replace('_START_',Math.round((oSettings._iDisplayStart+1)/2)).
						replace('_END_',Math.round((oSettings.fnDisplayEnd())/2)).
						replace('_TOTAL_',Math.round((oSettings.fnRecordsDisplay())/2))+ 
			...
			else
			{
				...
				nFirst.innerHTML = 
					oSettings.oLanguage.sInfo.
						...
						replace('_END_',Math.round((oSettings.fnDisplayEnd())/2)).
						replace('_TOTAL_',Math.round((oSettings.fnRecordsDisplay())/2)) +' '+ 
					oSettings.oLanguage.sInfoFiltered.replace('_MAX_', Math.round((oSettings.fnRecordsTotal())/2))+ 
					oSettings.oLanguage.sInfoPostFix;
			}
